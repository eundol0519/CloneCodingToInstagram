...
const apis = {
  ...
  commentWrite: (postId, commentInfo) => instance.post(`/api/comments/${postId}`,commentInfo),// 댓글 작성
  ...
  editMyProfile: (nickname, myPageInfo) => instance.PUT(`/api/mypage/modify/${nickname}`, myPageInfo),// 마이페이지/내 정보 수정
